...
pub struct Translations {
    ...
    pub settings_tab_voice: &'static str,
    pub settings_tab_language: &'static str,
    pub settings_tab_keybinds: &'static str,
    pub settings_tab_security: &'static str,
    pub settings_tab_network_proxy: &'static str,
    pub settings_tab_updates: &'static str,
    pub keybind_mute_title: &'static str,
    pub keybind_mute_desc: &'static str,
    pub keybind_deafen_title: &'static str,
    pub keybind_deafen_desc: &'static str,
    pub keybind_recording_prompt: &'static str,
    pub keybind_btn_record: &'static str,
    pub keybind_btn_clear: &'static str,
    pub keybind_guide_title: &'static str,
    pub keybind_guide_desc: &'static str,
}
...
pub const EN_TRANSLATIONS: Translations = Translations {
    ...
    settings_tab_keybinds: "Keybinds",
    settings_tab_security: "Security & E2EE",
    settings_tab_network_proxy: "Network & Proxy",
    settings_tab_updates: "Updates & About",
    keybind_mute_title: "Toggle Mute",
    keybind_mute_desc: "Global shortcut to mute or unmute your microphone during voice calls.",
    keybind_deafen_title: "Toggle Deafen",
    keybind_deafen_desc: "Global shortcut to deafen or undeafen all voice audio and microphone.",
    keybind_recording_prompt: "Press desired key combination...",
    keybind_btn_record: "Record Keybind",
    keybind_btn_clear: "Disable",
    keybind_guide_title: "Global Shortcuts",
    keybind_guide_desc: "Keybinds work seamlessly across all applications and games, even when Litecord is in background.",
};
...
pub const PT_TRANSLATIONS: Translations = Translations {
    ...
    settings_tab_voice: "Voz & Áudio",
    settings_tab_language: "Idioma",
    settings_tab_keybinds: "Atalhos",
    settings_tab_security: "Segurança & E2EE",
    settings_tab_network_proxy: "Rede & Proxy",
    settings_tab_updates: "Atualizações & Sobre",
    keybind_mute_title: "Mutar / Desmutar Microfone",
    keybind_mute_desc: "Atalho global para mutar ou desmutar seu microfone durante chamadas.",
    keybind_deafen_title: "Ensurdecer / Desensurdecer",
    keybind_deafen_desc: "Atalho global para ensurdecer ou desensurdecer todo áudio e microfone.",
    keybind_recording_prompt: "Pressione a combinação de teclas...",
    keybind_btn_record: "Gravar Atalho",
    keybind_btn_clear: "Desativar",
    keybind_guide_title: "Atalhos Globais",
    keybind_guide_desc: "Os atalhos funcionam em qualquer janela ou jogo em tela cheia, mesmo com o Litecord minimizado.",
};
...
pub const ES_TRANSLATIONS: Translations = Translations {
    ...
    settings_tab_voice: "Voz y Audio",
    settings_tab_language: "Idioma",
    settings_tab_keybinds: "Atajos",
    settings_tab_security: "Seguridad y E2EE",
    settings_tab_network_proxy: "Red y Proxy",
    settings_tab_updates: "Actualizaciones y Sobre",
    keybind_mute_title: "Silenciar / Desilenciar Micrófono",
    keybind_mute_desc: "Atajo global para activar o desactivar tu micrófono en llamadas de voz.",
    keybind_deafen_title: "Ensordecer / Desensordecer",
    keybind_deafen_desc: "Atajo global para ensordecer o reactivar todo el sonido y micrófono.",
    keybind_recording_prompt: "Presiona la combinación de teclas...",
    keybind_btn_record: "Grabar Atajo",
    keybind_btn_clear: "Desactivar",
    keybind_guide_title: "Atajos Globales",
    keybind_guide_desc: "Los atajos funcionan en cualquier ventana o juego a pantalla completa, incluso con Litecord minimizado.",
};
...
pub const DE_TRANSLATIONS: Translations = Translations {
    ...
    settings_tab_voice: "Sprach & Audio",
    settings_tab_language: "Sprache",
    settings_tab_keybinds: "Tastenbelegung",
    settings_tab_security: "Sicherheit & E2EE",
    settings_tab_network_proxy: "Netzwerk & Proxy",
    settings_tab_updates: "Updates & Über",
    keybind_mute_title: "Stummschaltung umschalten",
    keybind_mute_desc: "Globaler Shortcut zum Stummschalten oder Aktivieren des Mikrofons.",
    keybind_deafen_title: "Taubstellen umschalten",
    keybind_deafen_desc: "Globaler Shortcut zum Deaktivieren von Audio und Mikrofon.",
    keybind_recording_prompt: "Tastenkombination drücken...",
    keybind_btn_record: "Aufnehmen",
    keybind_btn_clear: "Deaktivieren",
    keybind_guide_title: "Globale Tastenkombinationen",
    keybind_guide_desc: "Shortcuts funktionieren auch in Vollbildspielen und im Hintergrund.",
};
...
pub const FR_TRANSLATIONS: Translations = Translations {
    ...
    settings_tab_voice: "Vocal & Audio",
    settings_tab_language: "Langue",
    settings_tab_keybinds: "Raccourcis",
    settings_tab_security: "Sécurité & E2EE",
    settings_tab_network_proxy: "Réseau & Proxy",
    settings_tab_updates: "Mises à jour & À propos",
    keybind_mute_title: "Couper / Réactiver le micro",
    keybind_mute_desc: "Raccourci global pour couper ou réactiver votre micro en vocal.",
    keybind_deafen_title: "Assourdir / Désassourdir",
    keybind_deafen_desc: "Raccourci global pour couper tout le son entrant et votre micro.",
    keybind_recording_prompt: "Appuyez sur la combinaison de touches...",
    keybind_btn_record: "Enregistrer",
    keybind_btn_clear: "Désactiver",
    keybind_guide_title: "Raccourcis Globaux",
    keybind_guide_desc: "Les raccourcis fonctionnent dans n'importe quel jeu ou application, même en arrière-plan.",
};
...
pub const RU_TRANSLATIONS: Translations = Translations {
    ...
    voice_connecting_desc: "Аутентификация в Voice Gateway v9 и согласование E2EE шифрования (Дэйв)...",
    ...
    settings_tab_voice: "Голос и Звук",
    settings_tab_language: "Язык",
    settings_tab_keybinds: "Горячие клавиши",
    settings_tab_security: "Безопасность и E2EE",
    settings_tab_network_proxy: "Сеть и Прокси",
    settings_tab_updates: "Обновления и О программе",
    keybind_mute_title: "Вкл/Выкл микрофон",
    keybind_mute_desc: "Глобальная клавиша для включения или выключения микрофона.",
    keybind_deafen_title: "Заглушить / Включить звук",
    keybind_deafen_desc: "Глобальная клавиша для отключения всех звуков и микрофона.",
    keybind_recording_prompt: "Нажмите комбинацию клавиш...",
    keybind_btn_record: "Записать клавишу",
    keybind_btn_clear: "Отключить",
    keybind_guide_title: "Глобальные клавиши",
    keybind_guide_desc: "Горячие клавиши работают во всех играх и приложениях, даже когда окно свернуто.",
};
...
pub const JA_TRANSLATIONS: Translations = Translations {
    ...
    settings_tab_voice: "音声 & オーディオ",
    settings_tab_language: "言語",
    settings_tab_keybinds: "キー割り当て",
    settings_tab_security: "セキュリティ & E2EE",
    settings_tab_network_proxy: "ネットワーク＆プロキシ",
    settings_tab_updates: "アップデート & 詳細",
    keybind_mute_title: "マイクミュート切替",
    keybind_mute_desc: "通話中にマイクのミュート/ミュート解除を切り替えるグローバルショートカット。",
    keybind_deafen_title: "スピーカーミュート切替",
    keybind_deafen_desc: "すべての音声とマイクを遮断するグローバルショートカット。",
    keybind_recording_prompt: "キーの組み合わせを押してください...",
    keybind_btn_record: "キーを記録",
    keybind_btn_clear: "無効化",
    keybind_guide_title: "グローバルショートカット",
    keybind_guide_desc: "ゲーム中や最小化時でもバックグラウンドで動作します。",
};
